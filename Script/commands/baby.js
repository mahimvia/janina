...
const simsim = "https://simsimi-fun.vercel.app";
...
module.exports.run = async function ({ api, event, args, Users }) {
 ...
 const res = await axios.get(`${simsim}/sim?text=${encodeURIComponent(query)}&senderName=${encodeURIComponent(senderName)}`);
...
module.exports.handleEvent = async function ({ api, event, Users }) {
 ...
 const greetings = [ "তুমি কি জানো, আমি তো বট! 😂 প্রেম-ভালবাসা আমার জন্য না।",
