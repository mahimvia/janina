...
const cuteReplies = [
  ...
  "bye", "naw message daw m.me/mahim.ghumacche", "mb ney bye", "meww", "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏",
...
module.exports.handleReply = async ({ api, event }) => {
  ...
  try {
    const response = await axios.get(`https://www.noobs-api.rf.gd/dipto/baby?text=${encodeURIComponent(body)}&senderID=100088769563815&font=1`);
    const reply = response.data.reply || "I didn't get that. Try asking something else!";
